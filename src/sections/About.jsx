...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('fauziramdani0112@gmail.com');
    setHasCopied(true);
          ...
          <div className="grid-container">
            <div className="rounded-3xl w-full sm:h-[326px] h-fit flex justify-center items-center">
              <Globe
                ...
                labelsData={[{ lat: -6.9175, lng: 107.6191, text: 'West Java, Indonesia', color: 'white', size: 15 }]}
              />
            </div>
            <div>
          ...
          <div className="grid-container">
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">fauziramdani0112@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
