...
const DemoComputer = (props) => {
  ...
  const texturePath = props.texture ? props.texture : '/textures/project/project1.mp4';
  const isVideo = texturePath.endsWith('.mp4') || texturePath.endsWith('.webm') || texturePath.endsWith('.mov');
  const txt = isVideo ? useVideoTexture(texturePath) : useTexture(texturePath);

  useEffect(() => {
    if (txt) {
      txt.flipY = isVideo ? false : true;
    }
  }, [txt, isVideo]);
